...
import com.downloader.internal.stream.FileDownloadOutputStreamClass;
...
public class DownloadTask_Copy {
    ...
    private FileDownloadOutputStreamClass outputStream;
    ...
    private DownloadTask_Copy(DownloadRequest request) {
        this.request = request;
    }

    static DownloadTask_Copy create(DownloadRequest request) {
        return new DownloadTask_Copy(request);
    }
    ...
    private void syncIfRequired(FileDownloadOutputStreamClass outputStream) {
    ...
    private void sync(FileDownloadOutputStreamClass outputStream) {
        boolean success;
        try {
    ...
    private void closeAllSafely(FileDownloadOutputStreamClass outputStream) {
        if (httpClient != null) {
            try {
                httpClient.close();
            } catch (Exception e) {
