 ...
 * @since 1.0
 */
public class UnitDetailsAdapter extends RecyclerView.Adapter<UnitDetailViewHolder>{

    private final String TAG=UnitDetailsAdapter.class.getSimpleName();
    private ArrayList<UnitContent> unitContents;
    private Context context;
    private UnitDetailsCallBacks unitDetailsCallBacks;

    public UnitDetailsAdapter(ArrayList<UnitContent> unitContents, Context context,UnitDetailsCallBacks unitDetailsCallBacks) {
    ...
    public UnitDetailViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View ticketCard = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_unit_content,parent,false);
